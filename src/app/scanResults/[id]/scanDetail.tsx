...
export default function ScanDetailclient({ id }: { id: string }) {
    const scans = useAppSelector(selectScans)
    const scan = scans.find((item: Scan) => item.id === Number(id)) || null;
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="hidden sm:flex mb-4">
                <div className="inline-flex items-center border p-2 rounded-xl border-borderGray cursor-pointer">
                    <Link
                        href="/scanresults"
